      ...
      <div className="container mx-auto px-4 py-12 flex justify-center">
        <div className="w-full max-w-md bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden">
          <div className="bg-[#003366] text-white px-6 py-4">
            ...
            <p className="text-sm text-blue-200 mt-1">Access your centre complaint dashboard.</p>
          </div>
          ...
          <form className="p-6 space-y-6">
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              Don't have an account? <Link to="/signup/centre-head" className="text-[#00509e] font-semibold hover:underline">Register here</Link>
            </p>
          </form>
        </div>
      </div>
