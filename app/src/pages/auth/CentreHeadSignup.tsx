      ...
      <div className="container mx-auto px-4 py-12 flex justify-center">
        <div className="w-full max-w-lg bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden">
          <div className="bg-[#2d2d2d] text-white px-6 py-4">
            ...
            <p className="text-sm text-zinc-300 mt-1">Register to manage complaints for your Building/Centre.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              Already registered? <Link to="/centre-head/login" className="text-[#4a4a4a] font-semibold hover:underline cursor-pointer">Login here</Link>
            </p>
          </form>
        </div>
      </div>
