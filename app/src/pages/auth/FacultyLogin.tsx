      ...
      <div className="container mx-auto px-4 py-12 flex justify-center">
        <div className="w-full max-w-md bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden">
          <div className="bg-[#003366] text-white px-6 py-4">
            ...
            <p className="text-sm text-blue-200 mt-1">Access your complaint dashboard.</p>
          </div>
          ...
          <form className="p-6 space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#00509e]" placeholder="faculty@nith.ac.in" required />
              </div>
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              Don't have an account? <Link to="/signup/faculty" className="text-[#00509e] font-semibold hover:underline">Register here</Link>
            </p>
          </form>
        </div>
      </div>
